...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="navigation" select="sc:item(sc:fld('Main Navigation Root', $root), $sc_currentitem)" />
  ...
  <xsl:template name="iscurrent">
    ...
    <xsl:if test="(($sc_currentitem/ancestor-or-self::item/@id = $navigationitem/@id) and ($navigationitem[@template != 'home'])) or ($sc_currentitem/@id = $navigationitem/@id)">
